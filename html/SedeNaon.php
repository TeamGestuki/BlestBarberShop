...
<head>
  ...
  <title>Sede Naón | Blest Barber Shop</title>
...
<body>
  ...
  <div class="sede-header">
    <div class="container">
      <div class="sede-tag"><i class="bi bi-geo-alt-fill"></i> Sede 01</div>
      <p class="section-eyebrow mb-2">Barrio Naón, CABA</p>
      <h1 class="section-title mb-0">Sede <span class="text-gold">Naón</span></h1>
      <div class="sede-info-strip">
        <span class="sede-info-item"><i class="bi bi-geo-alt-fill"></i> Montiel 1551, Barrio Naón</span>
...
<section class="barbers-section py-section">
  <div class="container">
    <div class="text-center mb-5">
      <p class="section-eyebrow">El equipo Naón</p>
  ...
  <section class="gallery-section py-section">
    <div class="container">
      <div class="text-center mb-5">
        ...
        <h2 class="section-title">Galería <span class="text-gold">Naón</span></h2>
      </div>
    <div class="gallery-grid">

      <div class="gallery-item" data-gallery="naon" data-index="0">
        <img src="../img/cortenaon.webp" alt="Trabajo 1">
        <div class="gallery-hover">
          <i class="bi bi-zoom-in"></i>
        </div>
      </div>

      <div class="gallery-item" data-gallery="naon" data-index="1">
        <img src="../img/cortenaon2.webp" alt="Trabajo 2">
        <div class="gallery-hover">
          <i class="bi bi-zoom-in"></i>
        </div>
      </div>

      <div class="gallery-item" data-gallery="naon" data-index="2">
        <img src="../img/cortenaon3.webp" alt="Trabajo 3">
        <div class="gallery-hover">
          <i class="bi bi-zoom-in"></i>
        </div>
      </div>

      <div class="gallery-item" data-gallery="naon" data-index="3">
        <img src="../img/cortenaon4.webp" alt="Trabajo 4">
        <div class="gallery-hover">
          <i class="bi bi-zoom-in"></i>
        </div>
      </div>

      <div class="gallery-item" data-gallery="naon" data-index="4">
        <img src="../img/cortenaon5.webp" alt="Trabajo 5">
        <div class="gallery-hover">
          <i class="bi bi-zoom-in"></i>
        </div>
      </div>
      ...
      <div class="gallery-item gallery-more"
        ...
        <img src="../img/cortenaon6.webp" alt="Ver más">
    ...
    <div class="container">
      <div class="row align-items-center g-5">
        <div class="col-lg-5">
          ...
          <h2 class="section-title">Sede <span class="text-gold">Naón</span></h2>
          <ul class="footer-contact-list mt-3">
            <li><i class="bi bi-geo-alt-fill"></i> Montiel 1551, Barrio Naón, CABA</li>
